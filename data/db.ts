...
export const profile_pic: string =
  "https://images.unsplash.com/photo-1504805572947-34fad45aed93?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fHByb2dyYW1tZXJ8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60";
export const updated_profile_pic =
  "https://avatars.githubusercontent.com/u/115598773?v=4";
...
export const accordionContent: Accordion[] = [
  ...
  },
  {
    ...
    content:
      "My favorite programming languages are Java, Golang, Javascript, and Python. I like JavaScript because it's a versatile language that can be used for both front-end and back-end development. I also like Python because it's a relatively easy language to learn and use, and it has a large community of developers who create and maintain a wide range of libraries and tools.",
  },
  {
    title: "The biggest challenge I've faced as a programmer",
    content:
      "The biggest challenge I've faced as a programmer is debugging code. When code doesn't work as expected, it can be difficult to track down and fix the bugs. This can be a frustrating process, especially for complex codebases. However, over time I've learned some tips for debugging code more effectively, such as using good coding practices, using a debugger, and asking for help from other programmers.",
  },
];
...
export const bannerImage =
  "https://images.unsplash.com/photo-1504805572947-34fad45aed93?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ZG8lMjBzb21ldGhpbmclMjBncmVhdHxlbnwwfHwwfHx8MA%3D%3D";

export const aboutMes = [
  {
    param:
      "Hi there! 👋🏾 I'm Carlos Kirui, your friendly web guy. I enjoy coding and creating websites that look great and work smoothly. Let's chat and see how we can bring your ideas to life! 🌐✨",
  },
  {
    param:
      "Hey everyone! 👋🏾 Carlos Kirui here, just a guy who loves playing around with code and making websites. Got a project in mind? Let's make it happen! 💡💻",
  },
  {
    param:
      "Hi, I'm Carlos Kirui! 👋🏾 I like building websites and making them look good. Let's work together and create something cool! 🌟🚀",
  },
  // {
...
export const resources = [
  ...
  {
    resource_url:
      "https://www.udemy.com/course/selenium-real-time-examplesinterview-questions/?couponCode=LETSLEARNNOWPP",
