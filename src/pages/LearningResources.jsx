        ...
        <MotionWrapper>
            ...
            <Box mt={12} mx={'20px'}>
                ...
                <Drawer placement={isMobile ? "bottom" : "right"} isOpen={selectedResource !== null} onClose={closeDrawer} size={isMobile ? "10%" : "lg"}>
                    <DrawerOverlay />
                    <DrawerContent fontSize={"18px"} borderTop={"3px solid black"} borderTopLeftRadius={"20px"} borderTopRightRadius={"20px"} color={'black'} bg={"#f5e0bc"} height={{ base: "500px", lg: "100%", sm: "500px" }}>
